...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Set mode in .env file. It can be "local" or "production".
    |
    */
    ...
    */
    ...
    'key' => env('APP_KEY', 'BPGGuvmy0Asmx78SKt6X0oco6i3oUBsL'),
    ...
    */
    ...
    'providers' => [
        ...
        Illuminate\Translation\TranslationServiceProvider::class,// This commented (Janis Supe)
