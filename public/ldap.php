...
$config = [
	...
	// Bind using user's DN - works
	//'bindDN' => 'mail=ztest1@tester.com,ou=Users,domainName=tester.com,o=domains,dc=9009,dc=in',
	//'bindPW' => 'jRztNGVlBudwvnG',
	
	// Bind using admin DN - works
	'bindDN' => 'cn=Manager,dc=9009,dc=in',
	'bindPW' => 'nfDKFHSxSPWVzVR',

	// LDAP catalog with user accounts
	'usersDN' => 'ou=Users,domainName=tester.com,o=domains,dc=9009,dc=in'
];
...
// Uncomment for debug (run from console)
//ldap_set_option(NULL, LDAP_OPT_DEBUG_LEVEL, 7);

// Bind to LDAP server
if(!ldap_bind($conn, $config['bindDN'], $config['bindPW']))
