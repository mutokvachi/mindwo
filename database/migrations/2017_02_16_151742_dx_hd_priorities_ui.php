...
class DxHdPrioritiesUi extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::transaction(function () {
            $table_name = "dx_hd_priorities";
            $list_name = "Prioritātes";
            $item_name = "Prioritātes";
    ...
    {
        DB::transaction(function () {
            \App\Libraries\DBHelper::deleteRegister('dx_hd_priorities');
            DB::table('dx_objects')->where('db_name', '=', 'dx_hd_priorities')->delete();
        });
    }
}
