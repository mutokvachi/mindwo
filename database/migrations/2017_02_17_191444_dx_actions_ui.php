...
class DxActionsUi extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::transaction(function () {
            $table_name = "dx_actions";
            $list_name = trans('db_dx_actions.list_name');
            $item_name = trans('db_dx_actions.item_name');
    ...
    {
        DB::transaction(function () {
            \App\Libraries\DBHelper::deleteRegister('dx_actions');
            DB::table('dx_objects')->where('db_name', '=', 'dx_actions')->delete();
        });
    }
}
