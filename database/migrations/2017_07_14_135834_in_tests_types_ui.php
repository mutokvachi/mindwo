...
class InTestsTypesUi extends EduMigration
{
   /**
     * Run the migrations.
     *
    ...
    {       
        ...
        DB::transaction(function () {
            $table_name = "in_tests_types";
            $list_name = trans('db_in_tests_types.list_name');
            $item_name = trans('db_in_tests_types.item_name');
            ...
            DB::table('in_tests_types')->insert(trans('db_in_tests_types.values'));
    ...
    {        
        DB::transaction(function () {
            \App\Libraries\DBHelper::deleteRegister('in_tests_types');
            DB::table('dx_objects')->where('db_name', '=', 'in_tests_types')->delete();
        });
    }
}
