...
class DxUsersSharesUi extends Migration
{
    ...
    public function down()
    {
        ...
        DB::transaction(function () {
            \App\Libraries\DBHelper::deleteRegister('dx_users_shares');
            DB::table('dx_objects')->where('db_name', '=', 'dx_users_shares')->delete();
        });
    }
}
