...
class EduSubjectsTagsCreate extends Migration
{
    private $table_name = "edu_subjects_tags";
    ...
    public function up()
    {
        ...
        Schema::create($this->table_name, function (Blueprint $table) {
            ...
            $table->integer('tag_id')->unsigned()->comment = trans('db_' . $this->table_name.'.tag_id');
