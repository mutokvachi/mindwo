...
class DxCurenciesUi extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {        
        DB::transaction(function () {
            \App\Libraries\DBHelper::deleteRegister('dx_currencies');
            DB::table('dx_objects')->where('db_name', '=', 'dx_currencies')->delete();
        });
    }
}
