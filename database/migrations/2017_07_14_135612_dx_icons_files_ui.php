...
class DxIconsFilesUi extends EduMigration
{
   /**
     * Run the migrations.
     *
    ...
    {       
        ...
        DB::transaction(function () {
            $table_name = "dx_icons_files";
            $list_name = trans('db_dx_icons_files.list_name');
            $item_name = trans('db_dx_icons_files.item_name');
    ...
    {        
        DB::transaction(function () {
            \App\Libraries\DBHelper::deleteRegister('dx_icons_files');
            DB::table('dx_objects')->where('db_name', '=', 'dx_icons_files')->delete();
        });
    }
}
