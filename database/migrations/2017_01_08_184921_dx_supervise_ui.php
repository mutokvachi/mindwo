...
class DxSuperviseUi extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::transaction(function () {
            $table_name = "dx_supervise";
            $list_name = "Supervision domains";
            $item_name = "Supervision domain";
    ...
    {
        DB::transaction(function () {
            \App\Libraries\DBHelper::deleteRegister('dx_supervise');
            DB::table('dx_objects')->where('db_name', '=', 'dx_supervise')->delete();
        });
    }
}
