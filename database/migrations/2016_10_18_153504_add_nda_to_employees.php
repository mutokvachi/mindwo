...
class AddNdaToEmployees extends Migration
{
    ...
    public function up()
    {
        ...
        // pievieno lauku CMSā
        $list = DB::table('dx_lists')->where('id', '=', Config::get('dx.employee_list_id'))->first();
        ...
        App\Libraries\DBHelper::addFieldToFormTab($list->id, $fld_id, 'Work details', 372);
        ...
        App\Libraries\DBHelper::addFieldToFormTab($list->id, $fld_id, 'Work details', 373);
    }
