...
class EduActivitiesUi extends EduMigration
{
    /**
     * Run the migrations.
     *
    ...
    {       
        ...
        DB::transaction(function () {
            $table_name = "edu_activities";
            $list_name = trans('db_edu_activities.list_name');
            $item_name = trans('db_edu_activities.item_name');
            ...
            DB::table('edu_activities')->insert(trans('db_edu_activities.values'));
    ...
    {        
        DB::transaction(function () {
            \App\Libraries\DBHelper::deleteRegister('edu_activities');
            DB::table('dx_objects')->where('db_name', '=', 'edu_activities')->delete();
        });
    }
}
