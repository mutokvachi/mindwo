...
class DxHdStatusesUi extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::transaction(function () {
            $table_name = "dx_hd_statuses";
            $list_name = "Darbu statusi";
            $item_name = "Darba statuss";
    ...
    {
        DB::transaction(function () {
            \App\Libraries\DBHelper::deleteRegister('dx_hd_statuses');
            DB::table('dx_objects')->where('db_name', '=', 'dx_hd_statuses')->delete();
        });
    }
}
