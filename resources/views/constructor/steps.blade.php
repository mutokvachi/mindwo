<div class="mt-element-step">
  <div class="row step-line">
    ...
    <div class="dx-step-navigation col-md-2 mt-step-col last {{ $step == 'menu' ? 'active' : '' }}">
      ...
      <div class="mt-step-title uppercase font-grey-cascade">{{ trans('constructor.step_menu') }}</div>
      <div class="mt-step-content font-grey-cascade">{{ trans('constructor.step_menu_desc') }}</div>
    </div>
  </div>
</div>
