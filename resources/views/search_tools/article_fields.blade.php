<table border="0" width="100%" style="margin-bottom: -15px;" class="ie9-fix-placeholders">
    <tr>
        <td width="49%">Publicēšanas datums:</td>
        <td width="2%"></td>
        <td width="49%"></td>
    </tr>
</table>
...
<div class="input-group" id="defaultrange" style='width: 49%; min-width: 240px;'>
    <input type="text" class="form-control" readonly style='background-color: white; cursor: pointer;' placeholder="Publicēšanas datums">
