...
<script src="../build/pdf.js"></script>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            var lbl = mozL10n.get('loading_label', null, 'Loading...');
            $("#spinner span").html(lbl);
            $("#spinner").show();
            
            var timer = function() {
                setTimeout(function(){ 
                    if ($("#viewer").html().length > 0) {
                        $("#spinner").hide();
                    }
                    else {
                        timer();
  ...
  <body tabindex="1" class="loadingInProgress">
    <div id="spinner" class="spinner loading-message-boxed" style="display:none;" >        
        <img id="img-spinner" src="images/loading.gif" alt="Loading"/><br>
        <span>&nbsp;&nbsp;Loading...</span>        
    </div>
