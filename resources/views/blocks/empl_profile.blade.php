<div class="portlet light dx-employee-profile" dx_is_init="0">
  ...
  <div class="portlet-body">
            ...
            <div class="employee-details-1">
              ...
              <div class="text-left">
                ...
                <p style="margin-bottom: 0px;">
                  @if($external['flag']->flag_file_guid && file_exists(base_path('public/img/'.$external['flag']->flag_file_guid)))
    ...
    <div class="tab-content">
      ...
      <div class="tab-pane fade {{ ($empl_row->id == Auth::user()->id) ? "" : " active in" }}" id="tab_team">
