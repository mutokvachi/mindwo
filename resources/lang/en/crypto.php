...
return [
    ...
    'e_encrypt_db_size' => "Can't encrypt field because it's database column is too small. Current database column size is :current. Change databse column size to :needed or change column type to 'TEXT'. This operation can't be done through this system's interface, it must be done directly in databse by system's admin.",
