...
/*
|--------------------------------------------------------------------------
| Labels for CMS register (grid and form labels) - table dx_menu
|--------------------------------------------------------------------------
*/
return [    
    
    'is_title_hidden' => 'Is title hidden',
    'hint_is_title_hidden' => "If marked, then title won't be visible in UI menu. Title will be visible only in menu configuration page.",
